...
# Prompt 11 - Ejecutar el prompt que genera el sub-agente
```text
execute prompt @prompts/prompts-svg/create-product-owner-agent.md
``` 

# Prompt 12 - Generar prompt para un comando enriquecer ticket
```text
...
# Prompt 13  - Ejecutar el prompt que genera el comando
```text
execute prompt @prompts/prompts-svg/create-enrich-ticket-command.md
``` 

# Prompt 14 - Modificar skills para que usen o tengan en cuenta las rules 
```text
...
# Prompt 16 - Ejecutar el prompt que genera el comando
```text
execute prompt @prompts/prompts-svg/create-develop-ticket-command.md
``` 

# Prompt 17 - Usar skill product-owner para dividir la tarea solicitada en tareas subatómicas
```text
